...
<body>
    ...
    <div class="container mt-2">
        ...
        <div class="row">
            ...
            <div>
                <a href="{{ route('addresses.index') }}" class="btn btn-primary">Back</a>
            </div>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                ...
                @endif
                {{-- <form id="editForm" action="{{route('addresses.update',$addresses->id)}}" method="POST"> --}}
                <form id="editForm">
                    @csrf
                    @method('PUT')
                    <div id="name-group" class="form-group">
                        <input type="hidden" name="addresses_id" id="addresses_id" value="{{ $address->id }}">
                        <label for="name">Detail</label>
                        <input type="text" value="{{ $address->detail }}" class="form-control" id="detail"
            ...
            $(document).ready(function() {
                ...
                $('#editBtn').click(function(e) {
                    ...
                    $.ajax({
                        ...
                        type: "PUT",
                        url: '{{ url('addresses', '') }}' + '/' + id + '/edit'+'/'+$("#detail").val()+'/'+$("#reference").val(),
                        cache: false,
                        contentType: false,
                        processData: false,
                        dataType: 'JSON',
